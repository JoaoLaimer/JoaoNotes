...
## Update 
Provides a system with additional functionality, but ir does not usually provide any patching of security related issues.
## Service Pack
Includes all the hotfixes and updates since the release of that system.
