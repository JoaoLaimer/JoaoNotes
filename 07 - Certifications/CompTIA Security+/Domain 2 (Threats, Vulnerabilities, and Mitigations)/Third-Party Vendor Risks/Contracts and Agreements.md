Written Documents that detail the rights, obligations, and expectations of the parties involved, and set up clear boundaries and guidelines.
...
Is a **legally binding** document that goes a step beyond the basic contract when two entities decide to pool their resources for mutual benefit. Aka Joint Venture (JV).
## Data Use Agreement (DUA)
Document that focuses on the specific data usage conditions.
