...
[[OWASP ZAP]] (Zed Attack Proxy) has a web spider tool you can use. [[BurpSuite]] has an equivalent tool called crawler.
...
| [altdns](https://github.com/infosec-au/altdns/)         | Tool for automating the process of discovering names that are permutations of other subdomain names.                            |
