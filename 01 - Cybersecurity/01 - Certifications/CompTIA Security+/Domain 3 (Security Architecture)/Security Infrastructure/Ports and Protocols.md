...
| 25               | Simple Mail Transfer Protocol (SMTP)                                  | TCP                | Provides the ability to send emails over the network.                                                                                                      |
| 53               | Domain Name System (DNS)                                              | UDP, TCP           | Translate domain names into IPs                                                                                                                            |
| 67/68            | Dynamic Host Configuration Protocol (DHCP)                            | UPD                | Used to allocated IP addresses to hosts dynamically. Port 67 is used by the listening server and port 68 is used to requesting hosts.                      |
...
| 123              | Network Time Protocol (NTP)                                           | UDP                | Protocol used for clock synchronization between computer systems.                                                                                          |
...
| 465 and 587      | SMTP Secure (SMTPS)                                                   | TCP                | Provides secure SMTP communication. (587 - TLS) (465 - SSL)                                                                                                |
...
| 5060/5061        | Voice Over IP (VoIP)/ VoIP TLS                                        | TCP/UDP            | Used for voice calls over internet protocol.                                                                                                               |
| 5900             | Virtual Network Computing (VNC)                                       | TCP                | Used for remote graphical desktop connections based on RFB (Remote Frame Buffer).                                                                          |
